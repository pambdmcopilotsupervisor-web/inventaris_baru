...
import {
  ...
  Umbrella, CheckSquare, Wallet, ClipboardCheck, Stethoscope, Timer, AlertTriangle,
    ...
    items: [
      {
        ...
        links: [
          ...
          { label: "Setoran Massal",     href: "/dashboard/keuangan/simpanan-massal", icon: <Users className="h-3.5 w-3.5" />, desc: "Input iuran banyak anggota sekaligus" },
          { label: "Buku Pembantu",      href: "/dashboard/keuangan/buku-pembantu", icon: <BookOpen className="h-3.5 w-3.5" />, desc: "Kartu simpanan, pinjaman, dan SHU anggota" },
          { label: "Pinjaman Anggota",   href: "/dashboard/keuangan/pinjaman", icon: <Wallet className="h-3.5 w-3.5" />, desc: "Piutang dan pembayaran pinjaman anggota" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        links: [
          ...
          { label: "RAPB vs Realisasi",  href: "/dashboard/keuangan/laporan/rapb-realisasi",    icon: <ClipboardList className="h-3.5 w-3.5" />, desc: "Anggaran vs realisasi pendapatan & beban" },
          { label: "Rekonsiliasi Bank",  href: "/dashboard/keuangan/rekonsiliasi-bank",          icon: <ArrowLeftRight className="h-3.5 w-3.5" />, desc: "Cocokkan buku dengan rekening bank" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        links: [
          ...
          { label: "RAPB",            href: "/dashboard/keuangan/rapb",            icon: <ClipboardList className="h-3.5 w-3.5" />, desc: "Rencana Anggaran Pendapatan & Belanja" },
          { label: "SHU per Anggota", href: "/dashboard/keuangan/shu-anggota", icon: <Users className="h-3.5 w-3.5" />, desc: "Alokasi SHU bagian anggota" },
        ],
      },
    ],
  },
