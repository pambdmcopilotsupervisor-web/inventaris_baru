  ...
  try {
    ...
    return NextResponse.json(serialize({
      ...
      shift: jadwal?.shift_kerjas ? {
        ...
        batas_absen_masuk_mulai:       jadwal.shift_kerjas.batas_absen_masuk_mulai ?? null,
        batas_absen_masuk_selesai:     jadwal.shift_kerjas.batas_absen_masuk_selesai ?? null,
        batas_absen_pulang_mulai:      jadwal.shift_kerjas.batas_absen_pulang_mulai ?? null,
        batas_absen_pulang_selesai:    jadwal.shift_kerjas.batas_absen_pulang_selesai ?? null,
      } : null,
      absensi: absensi ? {
        id:                    absensi.id,
